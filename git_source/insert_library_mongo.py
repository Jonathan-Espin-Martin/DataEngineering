...
client.drop_database('library_online')

# Insertar datos en la colección de autores
authors = [
...
# Insertar datos en la colección de libros
books = [
...
# Insertar datos en la colección de órdenes, incluyendo los detalles de las órdenes
orders = [
